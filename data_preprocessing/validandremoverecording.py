...
signals_path='C:/Users/Esteban/python_code/Recordings/New_ARM/audio_dataset/Session13'
...
#    print("CH1 power:"+str(sigpower_ch1))
    ...
    if sigpower_ch2<0.001 or math.isnan(sigpower_ch2):
        ...
        remove_file(directory+"/aligned_channel2.wav")
        channelcorrupted=True
    if sigpower_ch3<0.001 or math.isnan(sigpower_ch3):
        ...
        remove_file(directory+"/aligned_channel3.wav")
        channelcorrupted=True
    if sigpower_ch4<0.001 or math.isnan(sigpower_ch4):
        ...
        remove_file(directory+"/aligned_channel4.wav")
        channelcorrupted=True
